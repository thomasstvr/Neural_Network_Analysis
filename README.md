...
The target model performance was 75% accuracy, which the model fell just short of at what?. The original model’s accuracy was optimized through data preprocessing, trying more sophisticated models as well as allowing the learn time to run for more iterations.
